...
Waits for voicemeeter to start and then it injects a dll that .

[VoicemeeterBypassInjector readme](./src/VoicemeeterBypassInjector.md)


## VoicemeeterBypass.c (Currently not working on this)
[VoicemeeterBypass](./src/VoicemeeterBypass.md)
